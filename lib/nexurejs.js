// Nexure.js JavaScript Wrapper
import { ThreadPool, StringEncoder } from '../build/Release/nexurejs_native.node';
...
class NexureJS {
  ...
  getMetrics() {
    return {
      threadPool: this.threadPool.getQueueStats(),
...
export { NexureJS, defaultInstance as default };
